...
const Card = React.forwardRef<HTMLDivElement, React.HTMLAttributes<HTMLDivElement>>(({ className, ...props }, ref) => <div ref={ref} className={cn("rounded-2xl border border-white/80 bg-white/80 text-card-foreground shadow-soft backdrop-blur-xl", className)} {...props} />);
